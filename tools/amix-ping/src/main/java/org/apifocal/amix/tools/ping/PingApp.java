...
public class PingApp {
    ...
    private static final Option OPTION_LEN = Option
        .builder("l").longOpt("length").desc("Send message of 'len' bytes with random content").hasArg(true).argName("size").build();
    ...
    private static void help(PrintStream out) {
        ...
        formatter.printHelp(pw, HelpFormatter.DEFAULT_WIDTH,
             ...
             "\nFor more information visit https://docs.silkmq.com", true);
        pw.flush();
    }
